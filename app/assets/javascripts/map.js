...
function initMap() {
  ...
  for (var i = 0; i < markers.length; i++) {
      ...
      var marker = new google.maps.Marker({
          ...
          title: "<div class='job-posting-description'>" + markers[i].description + (markers[i].photo_url ? "<img style='width:100%' src='" + markers[i].photo_url + "'/>" : "") + "</div>" + (configuration.showRequestButton ? markers[i].request_job_link : '')
      });
